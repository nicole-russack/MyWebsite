       ...
       <div class = "JustImage">
        ...
        <div class = "InsideText">
          ...
          <p class = "textInBox">I am a current Junior at University of Southern California studying Computer Science and Business Administration. 
           ...
           I also enjoy crocheting, animals, and exploring LA.
          </p>
        </div>
      </div>

      <div class = "otherAboutMeText">
        <p class ="Actultext"> <span style={{fontSize:"30px", color:"#010440"}}>Relevant coursework: </span> Software Engineering, Data structures and Object-Oriented Design (C++), Principles of
Software Development (Java), Introduction to Algorithms, Introduction to Artificial Intelligence (Python)</p>
        <p class ="Actultext"><span style={{fontSize:"30px", color:"#010440"}}>Languages: </span>  React JS, Java, JavaScript, R, Python, C++, Swift, HTML5, CSS, NodeJS, Kotlin, SQL</p>
        <p class ="Actultext"><span style={{fontSize:"30px", color:"#010440"}}>Frameworks: </span> Amazon Web Services (AWS), Distributed Systems Management, Linux System Administration, MATLAB</p>
        <p class ="Actultext"><span style={{fontSize:"30px", color:"#010440"}}>Awards: </span>CURVE Researcher, USC Presidential Merit Scholar, USC Viterbi Dean's List, SCOPE Hackathon second 
          place best project, HACKSC 2nd best use of google cloud, CSCI 310 Best Project</p>
        <p class ="Actultext"><span style={{fontSize:"30px", color:"#010440"}}>Interests Outside of school: </span>Running, Cooking, Entrepreneurship, Hedgehogs, Yoga, Pickleball, Triathlons, Crocheting, Transit</p>
      </div>
